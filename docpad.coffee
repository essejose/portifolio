...
docpadConfig = {
	...
	templateData:
		...
		site:
			...
			title: "Essejose - Portifolio"

			# The website description (for SEO)
			description: """
				Desenvolvedor Front-end, exemplos de trabalhos criados por essejose.
				"""

			# The website keywords (for SEO) separated by commas
			keywords: """
				Desenvolvedor Front-end, Mobile Web, Website, Front-end.
				"""
